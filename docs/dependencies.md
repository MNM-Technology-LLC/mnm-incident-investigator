...
- Ollama and Qwen3 model weights are installed separately. Ollama is MIT; Qwen3-8B is Apache-2.0 under its upstream model license. See [model setup](model-setup.md). The repository contains synthetic application data and actual screenshots of that data, not client data.
